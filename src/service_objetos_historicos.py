...
from src import dao_queries_historicos as dao
from datetime import datetime
from src.log import log

def producto_mas_vendido_query_historico(fecha_menor,fecha_mayor):
    log.info("Consulta Service Historicos Producto Mas Vendido Historico")
    lista_producto_mas_vendido_platillos=[]
    lista_producto_mas_vendido_bebidas=[]
    lista_producto_mas_vendido_vinos=[]
    diccionario=dao.query_producto_mas_vendido_historico(fecha_menor,fecha_mayor)
...
def utilidad_por_hora_query_historico(fecha_menor,fecha_mayor):
    log.info("Consulta Service Historicos Utilidad Por Hora Historico")
    lista_utilidad_por_hora=[]
    diccionario=dao.query_utilidad_por_hora_historico(fecha_menor,fecha_mayor)
    for d in diccionario:
...
def mesero_query_historico(fecha_menor,fecha_mayor):
    log.info("Consulta Service Mesero")
    lista_mesero=[]
    lista_venta=[]
    diciconario=dao.query_mesero_historico(fecha_menor,fecha_mayor)
...
def return_final_response(fecha_menor,fecha_mayor):
    ...
    bebidas,platillos,vinos=producto_mas_vendido_query_historico(fecha_menor,fecha_mayor)
